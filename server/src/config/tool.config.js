...
//  Available Google Generative AI tools configuration, Also Tools are instantiated lazily to avoid initialization errors
...
const getEnabledTools = () => {
  ...
  try {
    ...
    console.error(chalk.red('[ERROR] Failed to initialize tools:'), err.message)
...
const resetTools = () => {
  ...
  console.log(chalk.gray('[DEBUG] All tools reset to disabled'))
}

export { getEnabledTools, availableTools, toggleTool, enableTools, getEnabledToolNames, resetTools }
